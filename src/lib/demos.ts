...
export const LIVE_DEMOS: LiveDemo[] = [
  { slug: 'hvac',             industry: 'HVAC',             url: `${DEMO_BASE}/hvac`,             status: 'Live', priority: 10, industryKeys: ['hvac', 'ac', 'air'],                        useCase: 'Primary niche. Use the HVAC demo when pitching HVAC leads.', outreachAngle: '"Your reviews are great but your site loses mobile callers - here is a fast HVAC demo"' },
