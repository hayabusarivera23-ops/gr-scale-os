...
export const LIVE_DEMOS: LiveDemo[] = [
  { slug: 'hvac',             industry: 'HVAC',             url: `${DEMO_BASE}/hvac`,             status: 'Live', priority: 10, industryKeys: ['hvac', 'ac', 'air'],                        useCase: 'Primary niche. Use with every HVAC lead — or better, show meloair-v2.vercel.app (real client work).', outreachAngle: '"Your reviews are great but your site loses mobile callers — here\'s what Tampa HVAC companies are running now."' },
  ...
  { slug: 'barber',           industry: 'Barbershop',       url: `${DEMO_BASE}/barber`,           status: 'Live', priority: 5,  industryKeys: ['barber', 'hair'],                           useCase: 'Secondary niche. Lex The Barber is the portfolio piece; this demo backs it up.', outreachAngle: '"Your Instagram is fire but bookings live in your DMs. A booking-ready site fills your chair while you cut."' },
]
